...
#define ADC_Pot_TOTAL_CHANNELS_NUM             (1u)
#define ADC_Pot_SEQUENCED_CHANNELS_NUM         (1u)
#define ADC_Pot_DEFAULT_EN_CHANNELS            (1u)
#define ADC_Pot_NOMINAL_CLOCK_FREQ             (2666667)
