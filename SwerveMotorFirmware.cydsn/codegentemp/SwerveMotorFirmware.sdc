...
# Date: Thu, 04 Apr 2024 08:38:41 GMT
#set_units -time ns
create_clock -name {ADC_Pot_intClock(FFB)} -period 375 -waveform {0 187.5} [list [get_pins {ClockBlock/ff_div_10}]]
...
create_generated_clock -name {ADC_Pot_intClock} -source [get_pins {ClockBlock/hfclk}] -edges {1 15 31} [list]
