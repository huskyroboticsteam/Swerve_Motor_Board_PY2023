...
module StripLights_v2_2_4 (
	...
	cy_clock_v1_0
		#(.id("fee491c1-7792-468e-8d1a-c4a5e495ef83/4160579c-2790-4e09-b13b-bfa787be72a5"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=0, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=32767, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=PWM_Motor2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Motor2, CY_INSTANCE_SHORT_NAME=PWM_Motor2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_Motor2, )
...
module ADC_SAR_SEQ_P4_v2_50_6 (
	...
	cy_clock_v1_0
		#(.id("b676132f-53d4-439f-b1ea-27916c40e2fc/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__Limit1_net;
	wire [0:0] tmpIO_0__Limit1_net;
	wire [0:0] tmpINTERRUPT_0__Limit1_net;
	electrical [0:0] tmpSIOVREF__Limit1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Limit1
		 (.oe(tmpOE__Limit1_net),
		  .y({1'b0}),
		  .fb({Net_200}),
		  .io({tmpIO_0__Limit1_net[0:0]}),
		  .siovref(tmpSIOVREF__Limit1_net),
		  .interrupt({tmpINTERRUPT_0__Limit1_net[0:0]}),
		  .annotation({Net_48}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Limit1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Limit2_net;
	wire [0:0] tmpIO_0__Limit2_net;
	wire [0:0] tmpINTERRUPT_0__Limit2_net;
	electrical [0:0] tmpSIOVREF__Limit2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("068bddb1-817a-434f-8762-cd4b531b6db9"),
		  ...
		  .input_buffer_sel(2'b00))
		Limit2
		 (.oe(tmpOE__Limit2_net),
		  .y({1'b0}),
		  .fb({Net_223}),
		  .io({tmpIO_0__Limit2_net[0:0]}),
		  .siovref(tmpSIOVREF__Limit2_net),
		  .interrupt({tmpINTERRUPT_0__Limit2_net[0:0]}),
		  .annotation({Net_20}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Limit2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_0 PWM_Motor1 (
        .capture(1'b0),
        .cc(Net_175),
        .clock(Net_3),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Motor1PWM_net;
	wire [0:0] tmpFB_0__Motor1PWM_net;
	wire [0:0] tmpIO_0__Motor1PWM_net;
	wire [0:0] tmpINTERRUPT_0__Motor1PWM_net;
	electrical [0:0] tmpSIOVREF__Motor1PWM_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Motor1PWM
		 (.oe(tmpOE__Motor1PWM_net),
		  .y({Net_30}),
		  .fb({tmpFB_0__Motor1PWM_net[0:0]}),
		  .io({tmpIO_0__Motor1PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor1PWM_net),
		  .interrupt({tmpINTERRUPT_0__Motor1PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor1PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LED_Debug1_net;
	wire [0:0] tmpFB_0__LED_Debug1_net;
	wire [0:0] tmpIO_0__LED_Debug1_net;
	wire [0:0] tmpINTERRUPT_0__LED_Debug1_net;
	electrical [0:0] tmpSIOVREF__LED_Debug1_net;

	cy_psoc3_pins_v1_10
		#(.id("a25f6ff1-3261-4c7e-a44f-8ee452f96b36"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Debug1
		 (.oe(tmpOE__LED_Debug1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Debug1_net[0:0]}),
		  .io({tmpIO_0__LED_Debug1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Debug1_net),
		  .interrupt({tmpINTERRUPT_0__LED_Debug1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Debug1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_Debug2_net;
	wire [0:0] tmpFB_0__LED_Debug2_net;
	wire [0:0] tmpIO_0__LED_Debug2_net;
	wire [0:0] tmpINTERRUPT_0__LED_Debug2_net;
	electrical [0:0] tmpSIOVREF__LED_Debug2_net;

	cy_psoc3_pins_v1_10
		#(.id("601881cd-9fa4-4f92-8b77-c56b02877402"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Debug2
		 (.oe(tmpOE__LED_Debug2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Debug2_net[0:0]}),
		  .io({tmpIO_0__LED_Debug2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Debug2_net),
		  .interrupt({tmpINTERRUPT_0__LED_Debug2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Debug2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_CAN_net;
	wire [0:0] tmpFB_0__LED_CAN_net;
	wire [0:0] tmpIO_0__LED_CAN_net;
	wire [0:0] tmpINTERRUPT_0__LED_CAN_net;
	electrical [0:0] tmpSIOVREF__LED_CAN_net;

	cy_psoc3_pins_v1_10
		#(.id("06780d86-eb16-436d-9080-fde412be9088"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_CAN
		 (.oe(tmpOE__LED_CAN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_CAN_net[0:0]}),
		  .io({tmpIO_0__LED_CAN_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_CAN_net),
		  .interrupt({tmpINTERRUPT_0__LED_CAN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_CAN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_Error_net;
	wire [0:0] tmpFB_0__LED_Error_net;
	wire [0:0] tmpIO_0__LED_Error_net;
	wire [0:0] tmpINTERRUPT_0__LED_Error_net;
	electrical [0:0] tmpSIOVREF__LED_Error_net;

	cy_psoc3_pins_v1_10
		#(.id("2b72ab74-09a4-405c-afb6-72e7b4e676bd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__LED_Error_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    StripLights_v2_2_4 StripLights (
        .rdy(Net_115),
        .S0(Net_1416),
        .S1(Net_116),
        .S10(Net_117),
	...
	wire [0:0] tmpOE__Array_LED_net;
	wire [0:0] tmpFB_0__Array_LED_net;
	wire [0:0] tmpIO_0__Array_LED_net;
	wire [0:0] tmpINTERRUPT_0__Array_LED_net;
	electrical [0:0] tmpSIOVREF__Array_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("9ec5743a-2bf9-491f-8ebb-d1eb653ea889"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Array_LED
		 (.oe(tmpOE__Array_LED_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Array_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Array_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor1Fault_net;
	wire [0:0] tmpFB_0__Motor1Fault_net;
	wire [0:0] tmpIO_0__Motor1Fault_net;
	wire [0:0] tmpINTERRUPT_0__Motor1Fault_net;
	electrical [0:0] tmpSIOVREF__Motor1Fault_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("45990d41-61b1-415b-ab24-078e1c74afaa"),
		  ...
		  .input_buffer_sel(2'b00))
		Motor1Fault
		 (.oe(tmpOE__Motor1Fault_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor1Fault_net[0:0]}),
		  .io({tmpIO_0__Motor1Fault_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor1Fault_net),
		  .interrupt({tmpINTERRUPT_0__Motor1Fault_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor1Fault_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_69 = ~Net_78;


    assign Net_70 = ~Net_79;


    assign Net_71 = ~Net_80;


    assign Net_72 = ~Net_81;

	wire [0:0] tmpOE__Motor2Fault_net;
	wire [0:0] tmpFB_0__Motor2Fault_net;
	wire [0:0] tmpIO_0__Motor2Fault_net;
	wire [0:0] tmpINTERRUPT_0__Motor2Fault_net;
	electrical [0:0] tmpSIOVREF__Motor2Fault_net;

	cy_psoc3_pins_v1_10
		#(.id("53de780d-6390-4a9f-9d63-ee4c3ce3af77"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor2Fault
		 (.oe(tmpOE__Motor2Fault_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor2Fault_net[0:0]}),
		  .io({tmpIO_0__Motor2Fault_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor2Fault_net),
		  .interrupt({tmpINTERRUPT_0__Motor2Fault_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor2Fault_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_5 PWM_Motor2 (
        .capture(1'b0),
        .cc(Net_164),
        .clock(Net_133),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Motor1Direction_net;
	wire [0:0] tmpFB_0__Motor1Direction_net;
	wire [0:0] tmpIO_0__Motor1Direction_net;
	wire [0:0] tmpINTERRUPT_0__Motor1Direction_net;
	electrical [0:0] tmpSIOVREF__Motor1Direction_net;

	cy_psoc3_pins_v1_10
		#(.id("99bc9830-752b-4356-be7b-974852567190"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor1Direction
		 (.oe(tmpOE__Motor1Direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor1Direction_net[0:0]}),
		  .io({tmpIO_0__Motor1Direction_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor1Direction_net),
		  .interrupt({tmpINTERRUPT_0__Motor1Direction_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor1Direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor2PWM_net;
	wire [0:0] tmpFB_0__Motor2PWM_net;
	wire [0:0] tmpIO_0__Motor2PWM_net;
	wire [0:0] tmpINTERRUPT_0__Motor2PWM_net;
	electrical [0:0] tmpSIOVREF__Motor2PWM_net;

	cy_psoc3_pins_v1_10
		#(.id("c77c46a1-9129-4b16-92b3-7232b5e16fb1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor2PWM
		 (.oe(tmpOE__Motor2PWM_net),
		  .y({Net_167}),
		  .fb({tmpFB_0__Motor2PWM_net[0:0]}),
		  .io({tmpIO_0__Motor2PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor2PWM_net),
		  .interrupt({tmpINTERRUPT_0__Motor2PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor2PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("ef9c6ea3-5579-4b4c-b951-e77f92f209e1"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(4),
		  .period("0"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Motor2Direction_net;
	wire [0:0] tmpFB_0__Motor2Direction_net;
	wire [0:0] tmpIO_0__Motor2Direction_net;
	wire [0:0] tmpINTERRUPT_0__Motor2Direction_net;
	electrical [0:0] tmpSIOVREF__Motor2Direction_net;

	cy_psoc3_pins_v1_10
		#(.id("8c733dd7-5f0b-4300-80f2-a07b70bb3bad"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor2Direction
		 (.oe(tmpOE__Motor2Direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Motor2Direction_net[0:0]}),
		  .io({tmpIO_0__Motor2Direction_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor2Direction_net),
		  .interrupt({tmpINTERRUPT_0__Motor2Direction_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor2Direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor1CurrentSense_net;
	wire [0:0] tmpFB_0__Motor1CurrentSense_net;
	wire [0:0] tmpIO_0__Motor1CurrentSense_net;
	wire [0:0] tmpINTERRUPT_0__Motor1CurrentSense_net;
	electrical [0:0] tmpSIOVREF__Motor1CurrentSense_net;
	...
	assign tmpOE__Motor1CurrentSense_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor2CurrentSense_net;
	wire [0:0] tmpFB_0__Motor2CurrentSense_net;
	wire [0:0] tmpIO_0__Motor2CurrentSense_net;
	wire [0:0] tmpINTERRUPT_0__Motor2CurrentSense_net;
	electrical [0:0] tmpSIOVREF__Motor2CurrentSense_net;
    ...
    ADC_SAR_SEQ_P4_v2_50_6 ADC_Pot (
        .aclk(1'b0),
        .eoc(Net_532),
        .sdone(Net_533),
        .soc(1'b0),
